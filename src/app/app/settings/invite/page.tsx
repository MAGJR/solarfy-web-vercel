              ...
              <div className="sm:col-span-1">
                ...
                <div className="mt-1">
                  ...
                  >
                    ...
                    <option value="SALES_REP">Sales Rep - Can manage customers & proposals</option>
      ...
      <div className="bg-card border border-border rounded-lg shadow-sm">
        <div className="px-4 py-5 sm:p-6">
          ...
          <p className="text-sm text-muted-foreground">
            Invitation management will be available once we have the invitations list component integrated.
          </p>
        </div>
      </div>
    </div>
